                ...
                if (WhereClause == 'Where Id=') {
                    ...
                    for (var i = 0; i < UserArr.length; i++) {
                        ...
                        $("#UserTableBody").append(
                            ...
                            + "<td class='text-center'><a data-toggle='modal' data-target='#EditUserRecord' class='EditRecordCLS' data-UserIdEdit='" + UserArr[i].Id + "'><i class='fa fa-2x fa-edit'></i></a></td>"
                            + "<td class='text-center'><a class='EditRecordStatusCLS' data-UserStatusId='" + UserArr[i].Id + "' data-UserStatus='" + UserArr[i].Status + "'>" + StatusIcon + "</a></td>"
                            + "</tr>"
                        );
